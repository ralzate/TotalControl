...
class RegistriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registry" do
    assert_difference('Registry.count') do
      post registries_url, params: { registry: { departure_temperature: @registry.departure_temperature, entrance_temperature: @registry.entrance_temperature, user_id: @registry.user_id } }
    end
  ...
  test "should update registry" do
    patch registry_url(@registry), params: { registry: { departure_temperature: @registry.departure_temperature, entrance_temperature: @registry.entrance_temperature, user_id: @registry.user_id } }
