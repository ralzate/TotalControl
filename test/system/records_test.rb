...
class RecordsTest < ApplicationSystemTestCase
  ...
  test "creating a Record" do
    ...
    fill_in "Departure temperature", with: @record.departure_temperature
    fill_in "Entrance temperature", with: @record.entrance_temperature
    fill_in "Person", with: @record.person_id
